...
window.titleCase = function (evt) {
  var input = evt;
  return input.replace(/(^[A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœ]{1})|([^A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]+[A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœ]{1})/g, function (letter) {
...
window.formatNames = function (evt) {
  var input = evt;
  return input.replace(/(^[^A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]{1})|([^A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ \-']+)/, "").replace(/[ ]{1}[^A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]/, " ").replace(/[-]{1}[^A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]/, "-").replace(/[']{1}[^A-Za-záàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ]/, "'");
};
...
window.formatPhones = function (evt) {
  var input = evt;
  return input[0].replace(/[^+\d]/, "") + input.substring(1).replace(/([^\d .-]+)/, "").replace(/[ ]{1}[\D]/, " ").replace(/[-]{1}[\D]/, "-").replace(/[.]{1}[\D]/, ".");
};

window.formatStrings = function (evt) {
  var input = evt;
  return input.replace(/^[^A-Za-z0-9áàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ"()*@$£]/, "").replace(/[^A-Za-z0-9áàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ\s\-_'"°()#*@?,.:!%$£€{}[\]<>+/=&]+/, "").replace(/[ ]{2,}/, " ").replace(/[\r]{3,}/, "\r\r").replace(/[\n]{3,}/, "\n\n").replace(/["]{2,}/, '"').replace(/[']{2,}/, "'");
};
